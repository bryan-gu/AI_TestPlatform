    ...
    <el-dialog v-model="createVisible" title="邀请用户" width="520px" destroy-on-close>
      <el-form :model="createForm" label-width="80px">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 16px">
          ...
          <el-form-item label="所属项目"><el-input v-model="createForm.project" placeholder="所属项目" /></el-form-item>
        </div>
      </el-form>
...
onMounted(async () => {
  ...
  loading.value = true
  try {
    const [usersRes, statsRes, rolesRes] = await Promise.allSettled([getUsers(), getUserStats(), getRoles()])
